    ...
    <section>
      ...
      <div className="inline-block md:flex py-8 text-white">
        ...
        >
          <div className="flex justify-center items-center space-x-4">
            <div>
              <img src={ai5} className="w-12 h-12" alt="" />
            </div>
            <div>
          ...
          <div className="flex justify-center items-center space-x-4">
            <div>
              <img src={ai4} className="w-12 h-12" alt="" />
            </div>
            <div>
              <h2 className="text-lg font-bold">Annotate</h2>
              <p className="text-gray-500">
          ...
          <div className="flex justify-center items-center space-x-4">
            <div>
              <img src={ai3} className="w-12 h-12" alt="" />
            </div>
            <div>
              <h2 className="text-lg font-bold">Annotate</h2>
              <p className="text-gray-500">
        ...
        <div className="py-4 relative z-20">
          ...
          >
            <img src={dashboard} className="w-full h-full " alt="" />
          </motion.div>
        </div>
      </div>
      {/* middiel */}
      <div className="md:flex flex-row-reverse py-16 text-white">
        ...
        >
          <div className="flex justify-center items-center space-x-4">
            <div>
              <img src={ai2} className="w-12 h-12" alt="" />
            </div>
            <div>
          ...
          <div className="flex justify-center items-center space-x-4">
            <div>
              <img src={ai1} className="w-12 h-12" alt="" />
            </div>
            <div>
