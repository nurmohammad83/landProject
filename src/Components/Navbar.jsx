      ...
      <div className="mx-auto max-w-screen-xl p-2 sm:p-4">
        <div className="flex relative items-center justify-between gap-4 lg:gap-10">
          ...
          <nav className="hidden gap-8 text-base font-medium md:flex">
            <a  className="text-gray-400 hover:text-[#ff0080] transition-all ease-in-out duration-300" href="#section-1">
              Home
            </a>
            <a className="text-gray-400 hover:text-[#ff0080] transition-all ease-in-out duration-300" href="#section-9">
              Blog
            </a>
            <a className="text-gray-400 hover:text-[#ff0080] transition-all ease-in-out duration-300" href="#section-3">
              Projects
            </a>
            <a className="text-gray-400 hover:text-[#ff0080] transition-all ease-in-out duration-300" href="#section-11">
              Contact
            </a>
          </nav>
