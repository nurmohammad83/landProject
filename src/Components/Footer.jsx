                    ...
                    <li>
                      ...
                      >
                        ...
                        <span className="relative flex h-2 w-2">
                          <span className="absolute inline-flex h-full w-full animate-ping rounded-full bg-[#ff0080] opacity-75"></span>
                          <span className="relative inline-flex h-2 w-2 rounded-full bg-[#ff0080]"></span>
                        </span>
                      </a>
                    </li>
                  </ul>
